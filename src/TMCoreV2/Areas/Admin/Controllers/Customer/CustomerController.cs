...
namespace TMCoreV2.Areas.Admin.Controllers.Customer
{
    [Area("Admin")]
    ...
    public class CustomerController : Controller
    {
        ...
        public IActionResult CustomerIndex(int page = 1)
        {
            ...
            {
                Customers = new PageData<TMCoreV2.DataAccess.Models.Customer.Customer>(currentCustomerPage, totalPostCount, page, PostsPerPage)
            });
        }
        ...
        public IActionResult Form(CustomerForm form, string returnUrl, string action)
        {
            if (action == "CreatePost" || action == "UpdatePost")
            {
                ...
                TMCoreV2.DataAccess.Models.Customer.Customer customer;
                if (form.IsNew)
                {
                    customer = new TMCoreV2.DataAccess.Models.Customer.Customer
                    {
